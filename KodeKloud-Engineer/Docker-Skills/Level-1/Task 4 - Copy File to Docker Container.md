...
## My Comments
I rarely have had to copy files into docker machines in my experience, used ' sudo docker --help ' to fined the ' cp ' command is valid with docker, and dug in the help menu with cp ' sudo docker cp --help ' to determine command syntax.
